...
int main( int argc, char** argv ) 
{
	...
	//【1】准备参数
	g_rectangle = Rect(-1,-1,0,0); //初始化
	//定义并初始化矩阵（图像）srcImage，长宽分别为600 * 800；CV_8UC3表示存储类型，3表示通道数；
	...
	setMouseCallback(WINDOW_NAME,on_MouseHandle,(void*)&srcImage);//(void*)&srcImage为传递给处理时间的参数
